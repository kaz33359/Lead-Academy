...
<head>
    ...
    <title>BEKAL INTERNATIONAL - Blog Manager </title>
    <link rel="icon" type="image/x-icon" href="assets/img/bekal/logo.png" />
                ...
                <li class="nav-item dropdown user-profile-dropdown order-lg-0 order-1">
                    <a href="javascript:void(0);" class="nav-link dropdown-toggle user" id="user-profile-dropdown"
                        ...
                        <div class="media">
                            ...
                            <img src="assets/img/bekal/logo.png" class="img-fluid" alt="admin-profile">
