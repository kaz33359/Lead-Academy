...
<head>
    ...
    <title>LEADS ACADEMY - Enquiry</title>
    <link rel="icon" type="image/x-icon" href="assets/img/leads/favicon.jpg" />
        ...
        <header class="header navbar navbar-expand-sm">
            ...
            <div class="nav-logo align-self-center">
                <a class="navbar-brand" href="{{ url('admin/index') }}"> <img alt="logo"
                        src="assets/img/leads/leadslogo.png"><span class="navbar-brand-name"></span></a>
            </div>
                ...
                <li class="nav-item dropdown user-profile-dropdown order-lg-0 order-1">
                    <a href="javascript:void(0);" class="nav-link dropdown-toggle user" id="user-profile-dropdown"
                        ...
                        <div class="media">
                            ...
                            <img src="assets/img/leads/favicon.jpg" class="img-fluid" alt="admin-profile">
                ...
                <ul class="navbar-nav theme-brand flex-row  text-center">
                    <li class="nav-item theme-logo">
                        <a href="{{ url('admin/index') }}">
                            <img src="assets/img/leads/leadslogo.png" class="navbar-logo" alt="logo">
                        </a>
                    </li>
        ...
        <div id="content" class="main-content">
                                    ...
                                    @foreach ($enquiry as $item)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{ url('admin/enquiry_delete') }}/{{ $item->id }}"
                                                    class="bs-tooltip" data-toggle="tooltip" data-placement="top"
                                                    title="" data-original-title="Delete session"><svg
            ...
            <div class="footer-wrapper">
                <div class="footer-section f-section-1">
                    <p class="">Copyright © 2022 Ignite, Designed By <a target="_blank"
                            href="https://thedaxads.com">DAXADS</a></p>
                </div>
