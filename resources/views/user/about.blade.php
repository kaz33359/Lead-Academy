                    ...
                    <div class="kingster-mobile-menu"><a class="kingster-mm-menu-button kingster-mobile-menu-button kingster-mobile-button-hamburger" href="#kingster-mobile-menu"><span></span></a>
                        <div class="kingster-mm-menu-wrap kingster-navigation-font" id="kingster-mobile-menu" data-slide="right">
                            <ul id="menu-main-navigation" class="m-menu">
                                <li class="menu-item menu-item-has-children"><a href="{{ url('/') }}">Home</a>
                                </li>
                                <li class="menu-item  menu-item-home current-menu-item menu-item-has-children"><a href="{{ url('/about') }}">About Us</a>
                                </li>
                                <li class="menu-item menu-item-has-children"><a href="{{ url('/blog') }}">Blog</a>
                                </li>
                                <li class="menu-item menu-item-has-children"><a href="{{ url('/contact') }}">Contact Us</a>
                                </li>
                            </ul>
                        </div>
                    </div>
        ...
        <div class="kingster-body-wrapper clearfix  kingster-with-frame">
            <div class="kingster-top-bar">
                ...
                <div class="kingster-top-bar-container kingster-container ">
                    <div class="kingster-top-bar-container-inner clearfix">
                        <div class="kingster-top-bar-left kingster-item-pdlr"><i class="fa fa-envelope-open-o" id="i_983a_0"></i> info@Lead.com <i class="fa fa-phone" id="i_983a_1"></i>  +91 497 796 4843</div>
                        ...
                        <div class="kingster-navigation kingster-item-pdlr clearfix ">
                            <div class="kingster-main-menu" id="kingster-main-menu">
                                <ul id="menu-main-navigation-1" class="sf-menu">
                                    <li class="menu-item menu-item-home menu-item-has-children kingster-normal-menu"><a href="{{ url('/') }}" class="sf-with-ul-pre">Home</a>
                                    </li>
                                    <li class="menu-item  current-menu-item  menu-item-has-children kingster-normal-menu"><a href="{{ url('/about') }}" class="sf-with-ul-pre">About Us</a>
                                    </li>
            ...
            <div class="kingster-breadcrumbs">
                <div class="kingster-breadcrumbs-container kingster-container">
                    <div class="kingster-breadcrumbs-item kingster-item-pdlr"> <span property="itemListElement" typeof="ListItem"><a property="item" typeof="WebPage" title="Go to Kingster." href="{{ url('/') }}" class="home"><span property="name">Home</span></a>
                                            ...
                                            <div class="gdlr-core-pbf-element">
                                                <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-left-align gdlr-core-title-item-caption-top gdlr-core-item-pdlr" id="div_983a_4">
                                                    <div class="gdlr-core-title-item-title-wrap clearfix">
                                                        <h3 class="gdlr-core-title-item-title gdlr-core-skin-title " id="h3_983a_0">Leads Academy </h3></div>
                                                </div>
                                            </div>
                                            <div class="gdlr-core-pbf-element">
                                            ...
                                            <div class="gdlr-core-pbf-element">
                                                <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align">
                                                    <div class="gdlr-core-text-box-item-content" id="div_983a_7">
                                                        <p style="font-weight: 100px; font-size: large; padding-left: 100px;">Engineering graduates and Diploma certificate holders who have recently graduated from college or university typically lack industry skills, placing them in a disadvantageous position when looking for work.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="gdlr-core-pbf-element">
                                                <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align">
                                                    <div class="gdlr-core-text-box-item-content" id="div_983a_8">
                                                        <p  style="font-weight: 100px; font-size: large; padding-left: 10px;">In order to bridge the gap between academic knowledge and the skill expectations of construction industry, Leads Academy offers Industrial Training in Civil Engineering for Civil Engineering graduates and final year students with specialized courses.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="gdlr-core-pbf-wrapper-container clearfix gdlr-core-container">
                                <div class="gdlr-core-pbf-element">
                                    <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-left-align gdlr-core-title-item-caption-top gdlr-core-item-pdlr" style="padding-bottom: 35px ;">
                                        <div class="gdlr-core-title-item-title-wrap clearfix">
                                            <h3 class="gdlr-core-title-item-title gdlr-core-skin-title " style="font-size: 45px ;font-weight: 600 ;letter-spacing: 0px ;text-transform: none ;">Certifications offered</h3></div>
                                    </div>
                                </div>
                                <div class="gdlr-core-pbf-column gdlr-core-column-40 gdlr-core-column-first">
                                    <div class="gdlr-core-pbf-column-content-margin gdlr-core-js ">
                                        <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js ">
                                            <div class="gdlr-core-pbf-element">
                                                <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align" style="padding-bottom: 5px ;font-size: 16px;">
                                                    <div class="gdlr-core-text-box-item-content" style="text-transform: none ;">
                                                        <p>Certifications offered by Scientific and Technical Development Council (STED Council)</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="gdlr-core-pbf-element">
                                                <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align">
                                                    <div class="gdlr-core-text-box-item-content" style="text-transform: none ; font-size: 17px;">
                                                        <p>The STED Council is an autonomous body and a national-level educational organisation registered since 2005 under the Government of Kerala and an Indian NGO under District Central, National Capital Territory (Govt. of N.C.T), New Delhi. It is certified by the Government of India and registered under the department of labour, Delhi, and recognised by the Ministry of MSME, Government of India, New Delhi. Registered under the NGO Partnership System, Planning Commission (Govt. of India). Regd. under TM Act-1999 Section 23(2) Rule 62(1) Class 41 by the Ministry of Commerce & Industry Department of Industrial Policy and Promotion Controller General Patents Designs and TM No. 1491711 dated 2006 under Govt. of India and also accredited as Facilitation Centre under NIELIT (formerly DOEACC) Dept. of Electronics and Information Technology (DeitY) Ministry of Communications and Information Technology, Government of India.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="gdlr-core-pbf-element">
                                                <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align" style="padding-bottom: 20px ;">
                                                    <div class="gdlr-core-text-box-item-content" style="font-size: 23px ;text-transform: none ;color: #ffffff ;">
                                                        <p>All certificates issued by STED COUNCIL can be attested by Ministry of External Affairs-Government of India and by the embassies of almost all countries as per the norms & conditions of the concerned.</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="gdlr-core-pbf-element">
                                        ...
                                        <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js ">
                                            <div class="gdlr-core-pbf-element">
                                                <div class="gdlr-core-image-item gdlr-core-item-pdlr gdlr-core-item-pdb  gdlr-core-center-align">
                                                    <div class="gdlr-core-image-item-wrap gdlr-core-media-image  gdlr-core-image-item-style-rectangle" style="border-width: 0px;"><img src="{{asset('user/assets/images/image5.jpg')}}" width="700" height="450"  alt="" /></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
