...
<head>
    ...
    <link rel='stylesheet' href='{{ asset('user/assets/plugins/goodlayers-core/plugins/combine/style.css') }}'
        type='text/css' media='all' />
    <link rel='stylesheet' href='{{ asset('user/assets/plugins/goodlayers-core/include/css/page-builder.css') }}'
        type='text/css' media='all' />
    <link rel='stylesheet' href='{{ asset('user/assets/plugins/revslider/public/assets/css/settings.css') }}'
        type='text/css' media='all' />
    <link rel='stylesheet' href='{{ asset('user/assets/css/style-core.css') }}' type='text/css' media='all' />
    <link rel='stylesheet' href='{{ asset('user/assets/css/kingster-style-custom.css') }}' type='text/css'
        media='all' />
...
<body
                ...
                <div class="kingster-logo  kingster-item-pdlr">
                    <div class="kingster-logo-inner">
                        <a class="" href="{{ url('/') }}"><img
                                src="{{ asset('user/assets/images/leadslogo.png') }}" alt="" /></a>
                    </div>
                </div>
                    ...
                    <div class="kingster-mobile-menu"><a
                        ...
                        <div class="kingster-mm-menu-wrap kingster-navigation-font" id="kingster-mobile-menu"
                            ...
                            <ul id="menu-main-navigation" class="m-menu">
                                ...
                                <li class="menu-item menu-item-has-children"><a href="{{ url('/about') }}">About
                                        Us</a>
                                </li>
                ...
                <div class="kingster-top-bar-container kingster-container ">
                    <div class="kingster-top-bar-container-inner clearfix">
                        <div class="kingster-top-bar-left kingster-item-pdlr"><i class="fa fa-envelope-open-o"
                                style="font-size: 15px ;color: #96a2b8 ;margin-right: 8px ;"></i> info@Lead.com <i
                                class="fa fa-phone"
                        ...
                        <div class="kingster-navigation kingster-item-pdlr clearfix ">
                            <div class="kingster-main-menu" id="kingster-main-menu">
                                <ul id="menu-main-navigation-1" class="sf-menu">
                                    <li class="menu-item menu-item-home menu-item-has-children kingster-normal-menu"><a
                                            href="{{ url('/') }}" class="sf-with-ul-pre">Home</a>
                                    </li>
                                    <li class="menu-item menu-item-has-children kingster-normal-menu"><a
                                            href="{{ url('/about') }}" class="sf-with-ul-pre">About Us</a>
                                    </li>
                                    <li class="menu-item menu-item-has-children kingster-normal-menu"><a
                                            href="{{ url('/blog') }}" class="sf-with-ul-pre">Blog</a>
                                    </li>
                                    <li
                                        class="menu-item current-menu-item menu-item-has-children kingster-normal-menu">
                                        <a href="{{ url('/contact') }}" class="sf-with-ul-pre">Contact Us</a>
                                    </li>
                                </ul>
                    ...
                    <div class="gdlr-core-pbf-wrapper " style="margin: 0px 0px 0px 0px;padding: 290px 0px 170px 0px;">
                        <div class="gdlr-core-pbf-background-wrap">
                            <div class="gdlr-core-pbf-background gdlr-core-parallax gdlr-core-js"
                                style="background-image: url({{ asset('user/assets/images/contact1.jpg') }}) ;background-size: cover ; background-position: center ;"
                                    ...
                                    <div
                                        ...
                                        <div class="gdlr-core-title-item-title-wrap clearfix">
                                            <h3 class="gdlr-core-title-item-title gdlr-core-skin-title "
                                                style="font-size: 75px ;font-weight: 700 ;color: #ffffff ;">Contact Us
                                            </h3>
                                        </div><span
                                            class="gdlr-core-title-item-caption gdlr-core-info-font gdlr-core-skin-caption"
                                            style="font-size: 25px ;font-style: normal ;letter-spacing: 1px ;text-transform: uppercase ;color: #ffffff ;margin-top: 15px ;">Get
                                            Intouch</span>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js ">
                                            <div class="gdlr-core-pbf-element">
                                                <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-left-align gdlr-core-title-item-caption-bottom gdlr-core-item-pdlr"
                                                    ...
                                                    <div class="gdlr-core-title-item-title-wrap clearfix">
                                                        <h3 class="gdlr-core-title-item-title gdlr-core-skin-title "
                                                            style="font-size: 32px ;font-weight: 700 ;">Leave us your
                                                            info</h3>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="gdlr-core-pbf-element">
                                                <div
                                                    ...
                                                    <div role="form" class="wpcf7" id="wpcf7-f1979-p1977-o1"
                                                        lang="en-US" dir="ltr">
                                                        ...
                                                        @endif
                                                        <form id="cmt-contactform-1"
                                                            class="cmt-contactform-1 wrap-form spacing-10 clearfix"
                                                            action="{{ route('user.enquiry') }}" method="post">
                                                            @csrf
                                        ...
                                        <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js ">
                                            <div class="gdlr-core-pbf-element">
                                                <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-left-align gdlr-core-title-item-caption-bottom gdlr-core-item-pdlr"
                                                    ...
                                                    <div class="gdlr-core-title-item-title-wrap clearfix">
                                                        <h3 class="gdlr-core-title-item-title gdlr-core-skin-title "
                                                            style="font-size: 28px ;font-weight: 700 ;">Location</h3>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="gdlr-core-pbf-element">
                                                <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align"
                                                    ...
                                                    <div class="gdlr-core-text-box-item-content"
                                                        ...
                                                        <p>Second Floor, Bilal Tower, Fort Rd,
                                                            Kannur, Kerala 670001</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="gdlr-core-pbf-element">
                                                <div
                                                    ...
                                                    <ul>
                                                        <li class=" gdlr-core-skin-divider gdlr-core-with-hover"><span
                                                                class="gdlr-core-icon-list-icon-wrap"><i
                                                                    class="gdlr-core-icon-list-icon-hover fa fa-envelope-o"
                                                                    style="font-size: 16px ;"></i><i
                                                                    class="gdlr-core-icon-list-icon fa fa-envelope-o"
                                                                    style="font-size: 16px ;width: 16px ;"></i></span>
                                                            <div class="gdlr-core-icon-list-content-wrap"><a
                                                                    href="mailto:info@Lead.com"><span
                                                                        class="gdlr-core-icon-list-content"
                                                                        style="font-size: 16px ;">info@Lead.com</span></a>
                                                            </div>
                                                        </li>
                                                        <li class=" gdlr-core-skin-divider gdlr-core-with-hover"><span
                                                                class="gdlr-core-icon-list-icon-wrap"><i
                                                                    ...
                                                                    style="font-size: 16px ;width: 16px ;"></i></span>
                                                            <div class="gdlr-core-icon-list-content-wrap"><a
                                                                    href="mailto:career@Lead.com"><span
                                                                        class="gdlr-core-icon-list-content"
                                                                        style="font-size: 16px ;"href="mailto:career@Lead.com">career@Lead.com</span></a>
                                                            </div>
                                                        </li>
                                                        <li class=" gdlr-core-skin-divider gdlr-core-with-hover"><span
                                                                class="gdlr-core-icon-list-icon-wrap"><i
                                                            ...
                                                            <div class="gdlr-core-icon-list-content-wrap"><span
                                                                    class="gdlr-core-icon-list-content"
                                                                    style="font-size: 16px ;">+91 497 796 4843</span>
                                                            </div>
                                                        </li>
                                                    </ul>
                                                </div>
                                            ...
                                            <div class="gdlr-core-pbf-element">
                                                <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-left-align gdlr-core-title-item-caption-bottom gdlr-core-item-pdlr"
                                                    ...
                                                    <div class="gdlr-core-title-item-title-wrap clearfix">
                                                        <h3 class="gdlr-core-title-item-title gdlr-core-skin-title "
                                                            style="font-size: 28px ;font-weight: 700 ;">Map</h3>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="gdlr-core-pbf-element">
                            ...
                            <div class="gdlr-core-pbf-wrapper-container clearfix gdlr-core-pbf-wrapper-full-no-space">
                                <div class="gdlr-core-pbf-element">
                                    <div class="gdlr-core-social-network-item gdlr-core-item-pdb  gdlr-core-center-align gdlr-core-item-pdlr"
                                        style="padding-bottom: 0px ;"><a href="mailto:#" target="_blank"
                                            class="gdlr-core-social-network-icon" title="email"
                                            style="font-size: 20px ;color: #232323 ;"><i
                                                class="fa fa-envelope"></i></a><a href="#" target="_blank"
                                            class="gdlr-core-social-network-icon" title="facebook"
                                            style="font-size: 20px ;color: #232323 ;margin-left: 37px ;"><i
                                                class="fa fa-facebook"></i></a><a href="#" target="_blank"
                                            class="gdlr-core-social-network-icon" title="whatsapp"
                                            style="font-size: 20px ;color: #232323 ;margin-left: 37px ;"><i
                                                class="fa fa-whatsapp"></i></a><a href="#" target="_blank"
            ...
            <footer>
                        ...
                        <div class="kingster-footer-column kingster-item-pdlr kingster-column-15">
                            <div id="text-2" class="widget widget_text kingster-widget">
                                <div class="textwidget">
                                    <p><img style="height: 85px; width: 275px;"
                                            src="{{ asset('user/assets/images/logocr.png') }}" alt="" />
                            ...
                            <div id="gdlr-core-custom-menu-widget-4"
                                ...
                                <div class="menu-academics-container">
                                    <p class="icon fa fa-phone"> Call Us <br>
                                        <a style="font-size: 18px; color: #ffffff;" href="tel:+91 497 796 4843"> +91
                                            497 796 4843</a>
                                    </p> <br>

                                    <p class="fa fa-envelope-o"> Write To Us <br> <a
                                            style="font-size: 18px; color: #ffffff;" href="mailto:info@Lead.com">
                                            info@Lead.com</a>
                                    </p>
                                </div>
                            </div>
                ...
                <div class="kingster-copyright-wrapper">
                    <div class="kingster-copyright-container kingster-container clearfix">
                        <div class="kingster-copyright-left kingster-item-pdlr">Copyright All Right Reserved 2022,
                            Designed by DaxAds</div>
    ...
    <script type='text/javascript' src='{{ asset('user/assets/plugins/goodlayers-core/plugins/combine/script.js') }}'>
    </script>
    ...
    <script type='text/javascript' src='{{ asset('user/assets/plugins/goodlayers-core/include/js/page-builder.js') }}'>
    </script>
    ...
    <script type='text/javascript' src='{{ asset('user/assets/js/isotope.js') }}'></script>
    <script type="text/javascript" src="{{ asset('user/assets/plugins/quform/js/plugins.js') }}"></script>
    <script type="text/javascript" src="{{ asset('user/assets/plugins/quform/js/scripts.js') }}"></script>
